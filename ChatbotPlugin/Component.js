sap.ui.define([
	...
	return Component.extend("com.aymax.button.chatbot.Component", {
		...
		init: function () {
			...
			s.setAttribute("data-channel-id", "bc");
			s.setAttribute("data-token", "ff0");

			s.setAttribute("data-expander-type", "CAI");
			s.setAttribute("data-expander-preferences", "=");
